        ...
        <div className="min-h-screen bg-gradient-to-b from-[#333641] to-[#282A32] text-white p-8">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="w-full max-w-2xl mb-4 mt-24">
                    <div className="w-full shadow-2xl max-w-2xl h-32 bg-2F323C flex justify-center">
                        <label className="block text-white opacity-75 mt-4">Apresenta falha:</label>
                        <span className="text-white opacity-75">{result_atual}</span>
                    </div>
                </div>
            </div>
        </div>
